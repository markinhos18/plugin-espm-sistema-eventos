...
class EventosPublicos_API {
    ...
    public static function Evento(){
        ...
        $token = EventosPublicos_API::Token();
        $url = "https://apieventos.espm.br/api/Publicos/GetPublicosPorVitrine?id=xQVvLZ69rKg";
        $curl = curl_init($url);
...
EventosPublicos_API::getInstance();
